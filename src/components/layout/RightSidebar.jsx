  ...
  return (
    <aside className="hidden lg:flex flex-col w-[320px] xl:w-[350px] h-screen bg-white border-l border-[#F1F5F9] px-6 py-8 sticky top-0 overflow-y-auto">
      <div className="flex items-center gap-2 mb-1.5">
        <ChefHat className="text-[#0F172A] w-6 h-6" strokeWidth={2.5} />
        <h2 className="text-[17px] font-black text-[#0F172A]">AI Chef's Corner</h2>
      </div>
      <p className="text-[13px] text-[#64748B] mb-8 font-medium">Smart suggestions based on your selection</p>

      {/* Meal of the Day */}
      <div className="mb-10">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-[11px] font-black uppercase tracking-widest text-[#64748B]">Meal of the day</h3>
          <span className="text-[11px] font-bold text-primary">Daily Pick</span>
        </div>
        ...
        <Card className="p-0 overflow-hidden border-none shadow-[0_4px_25px_-4px_rgba(0,0,0,0.08)] rounded-[20px]">
          <div className="relative h-[200px]">
            ...
            <div className="absolute top-4 left-4">
              <Badge className="bg-primary hover:bg-primary text-white border-none py-1 px-3 text-[11px] font-bold">Zero Waste</Badge>
            </div>
            
            <div className="absolute bottom-5 left-5 right-5 text-white">
              <h4 className="font-black text-[22px] leading-[1.1] mb-2 drop-shadow-sm">Harvest Veggie Medley</h4>
              <p className="text-[12px] text-white/90 font-medium flex items-center gap-3">
          ...
          <div className="p-5 bg-white">
            <p className="text-[13px] text-[#4A5568] mb-5 leading-[1.6]">
            ...
            <Button variant="secondary" className="w-full bg-[#E6F4F0] text-primary hover:bg-[#D1EBE3] justify-center text-[13px] h-11 font-bold gap-2 py-0 rounded-xl">
